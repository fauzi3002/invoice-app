        ...
        @forelse($struks as $struk)
            ...
            <div class="struk-card bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden" 
                ...
                <div class="p-3 bg-gray-50/50 border-t border-gray-100 flex gap-2">
                    ...
                    <button onclick="confirmDelete('{{ route('buat_struk.destroy', $struk->id) }}')"
                        ...
                        <td class="px-6 py-4">
                            <div class="flex justify-center gap-2">
                                ...
                                <form action="{{ route('buat_struk.destroy', $struk->id) }}" method="POST" onsubmit="return confirm('Hapus struk ini?')">
                                    @csrf @method('DELETE')
                                    <button type="button" 
                                            onclick="confirmDelete('{{ route('buat_struk.destroy', $struk->id) }}')"
                    ...
                    <tr>
                        <td colspan="7" class="px-6 py-12 text-center">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <p class="text-gray-500 font-medium">Belum ada data transaksi.</p>
                                <p class="text-gray-400 text-xs mt-1">Klik tombol "Buat Struk" untuk membuat transaksi baru.</p>
                            </div>
                        </td>
                    </tr>
                @endforelse
