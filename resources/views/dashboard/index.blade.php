    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 gap-3">
                <a href="{{ route('buat_struk.create') }}" class="flex items-center gap-4 p-4 bg-blue-900 text-white rounded-lg hover:bg-blue-800 transition shadow-lg shadow-blue-200">
                    <div class="p-2 bg-blue-800 rounded-lg">+</div>
                    <span class="font-bold text-sm">Buat Invoice Baru</span>
                </a>
                <a href="{{ route('produk.create') }}" class="flex items-center gap-4 p-4 bg-white border border-gray-200 text-gray-700 rounded-lg hover:bg-gray-50 transition">
